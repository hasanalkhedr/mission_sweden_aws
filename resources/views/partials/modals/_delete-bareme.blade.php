<div id="deleteModal-{{ $bareme->id }}" tabindex="-1" aria-hidden="true"
        ...
        <div class="relative bg-white rounded-lg shadow">
            ...
            <div class="p-6 space-y-6">
                <div class="text-base leading-relaxed text-gray-500">
                    {{ __('Are you sure you want to delete this bareme') }}?
            ...
            <div
                ...
                <div>
                    <button data-modal-toggle="deleteModal-{{ $bareme->id }}" type="button"
                ...
                <div>
                    <form method="POST"
                        action="{{ route('baremes.destroy', ['bareme' => $bareme->id]) }}">
                        @csrf
                        @method('DELETE')
                        <button data-modal-toggle="deleteModal-{{ $bareme->id }}"
